//===- afl_driver.c - a glue between AFL and libFuzzer --------*- C -* ===//
//
...
clang -g -fsanitize-coverage=trace-pc-guard test_fuzzer.c -c
# Build afl-llvm-rt.o.c from the AFL distribution.
clang -c -w $AFL_HOME/llvm_mode/afl-llvm-rt.o.c
# Build this file, link it with afl-llvm-rt.o.o and the target code.
clang afl_driver.c test_fuzzer.o afl-llvm-rt.o.o
# Run AFL:
